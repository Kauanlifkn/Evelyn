...
const typeOptions = [
  ...
  { value: 'gale', label: 'Vendaval' },
  { value: 'frost', label: 'Geada' },
  { value: 'low_humidity', label: 'Baixa Umidade' },
  { value: 'rain_accumulation', label: 'Acumulado de Chuva' },
  { value: 'coastal_winds', label: 'Ventos Costeiros' },
  { value: 'temperature_drop', label: 'Declínio de Temperatura' },
